...
\begin{enumerate}
    ...
    \item \textbf{Thu hẹp bề mặt tấn công:} Việc loại bỏ hoàn toàn các phụ thuộc ngoại vi (External Dependencies) giúp dự án tránh được các nguy cơ bị chèn mã độc thông qua lỗ hổng chuỗi cung ứng phần mềm (Supply Chain Attacks).
\end{enumerate}

Trong quá trình vận hành, hàm \texttt{encryptSecret} chịu trách nhiệm tự động sinh ra một Nonce ngẫu nhiên dài 12-byte (bằng \texttt{crypto.getRandom\-Values}), sau đó kết hợp với khóa bí mật để biến đổi văn bản thuần (Plaintext) thành bản mã (Ciphertext) an toàn trước khi gửi đến máy chủ.
...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \caption{Giao diện soạn thảo thông điệp và cấu hình thời gian sống (TTL)}
    ...
    \begin{figure}[H]
        ...
        \caption{Trạng thái trả về liên kết an toàn sau khi mã hóa thành công}
    ...
    \begin{figure}[H]
        ...
        \caption{Giao diện Anti-Bot buộc người nhận phải tương tác vật lý}
    ...
    \begin{figure}[H]
        ...
        \caption{Giao diện hiển thị nội dung thông điệp sau khi giải mã thành công}
    ...
    \begin{figure}[H]
        ...
        \caption{Giao diện thông báo lá thư đã bị huỷ vĩnh viễn}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}{0.48\textwidth}
            ...
            \caption{Cảnh báo khi liên kết thiếu đoạn khóa}
            \label{fig:ui_error_nokey}
        \end{minipage}\hfill
        \begin{minipage}{0.48\textwidth}
            \centering
            \includegraphics[width=\linewidth]{img/ui_error_wrongkey.png}
            \caption{Cảnh báo khi giải mã thất bại do sai khóa}
