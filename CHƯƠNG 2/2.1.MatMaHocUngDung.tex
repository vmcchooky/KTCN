...
\begin{enumerate}
    ...
    \item \textbf{Khử rủi ro chuỗi cung ứng (Supply Chain Security):} Thay vì phụ thuộc vào các thư viện mã nguồn mở tiềm ẩn lỗ hổng (như các gói NPM), AES-GCM được trình duyệt thực thi trực tiếp qua \textit{Web Cryptography API} (\textcite{w3c-webcrypto}). Việc vận hành nguyên bản (native) ở mức hệ điều hành giúp thu hẹp đáng kể bề mặt tấn công. 
