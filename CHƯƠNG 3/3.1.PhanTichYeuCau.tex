...
\begin{itemize}
    ...
    \item \textbf{Kiểm soát dữ liệu đầu vào (SR-5):} Dữ liệu từ Client bị giới hạn (tối đa 15KB). Các thao tác trên Redis được thiết lập thời gian chờ (Timeout 5 giây) nhằm hạn chế rủi ro nghẽn cổ chai.
\end{itemize}
