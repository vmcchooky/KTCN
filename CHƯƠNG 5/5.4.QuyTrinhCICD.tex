...
\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption[Sơ đồ kiến trúc CI/CD bằng GitHub Actions]{Sơ đồ tổng quan kiến trúc CI/CD bằng GitHub Actions}
    \label{fig:cicd_pipeline}
\end{figure}

\subsection[Tích hợp liên tục và Kiểm duyệt (CI)]{Giai đoạn 1: Tích hợp liên tục và Kiểm duyệt (CI)}
...
\subsection[Phát hành và Triển khai liên tục (CD)]{Giai đoạn 2: Phát hành và Triển khai liên tục (CD)}
